...
function redirectUser()
{
	...
	var dt = new Date();
	window.location = "Startup?action=abc&username="+username+"&userid="+userid+"&nextPage="+nxtPage+"&userAgent="+getUserAgent()+"&userOS="+getOS()+"&duration="+((dt.getTime()-loadTime)/1000)+"&source="+source+"&access="+access;
...
<tr> <td>Timestamp</td>		<td><input type="hidden" id="timestamp"/></td> </tr>
<tr> <td>Location</td>		<td><input type="hidden" id="location"/></td> </tr>
<tr> <td>UserAgent</td>		<td><input type="hidden" id="useragent"/></td> </tr>
<tr> <td>OS</td>			<td><input type="hidden" id="OS"/></td> </tr>
